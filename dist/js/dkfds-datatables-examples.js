...
},{"datatables.net":3}],2:[function(require,module,exports){
'use strict';
...
var dt = require('datatables.net')(window, $); //COre datatables
var dt_select = require('datatables.net-select')(window, $); //Makes datatable rows selectable
var dt_responsive = require('datatables.net-responsive')(window, $); //Makes datatables responsive
...
var datatablesExamples = function datatablesExamples(el) {
    ...
    var table_ajax = $(jsSelectorDatatable_Example_ajax).DataTable({
        ...
        'columns': [{ "data": "name" }, { "data": "email" }, { "data": "address.street" }, { "data": "address.city" }, { "data": "phone" }],
        'createdRow': function createdRow(row, data, dataIndex) {
            $(row).find('td').each(function (index, elm) {
                if (!$(elm).hasClass('row-control')) {
                    $(elm).attr('tabindex', 0); //Accessibility fix: make td's focusable by tab
    ...
    function format(d) {
        ...
        return '<div class="details-row-content">' + '<div class="row">' + '<div class="col-5">' + '<p class="h3">Headline</p>' + '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna <a href="#">aliqua</a>.</p>' + '<div class="responsive-content"></div>' + '</div>' + '<div class="col-6">' + '<img src="https://ramen-files.s3.amazonaws.com/charturl-images/2017-01-26/9b64e497-3a7a-40c8-b7c7-322f84f84ba9.png"></div>' + '</div>' + '</div>';
    }
    ...
    var table_detailsrow = $(jsSelectorDatatable_Example_detailsrow).DataTable({
        ...
        'columns': [{
            ...
            "defaultContent": '',
            "width": "24px"
        }, { "data": "name" }, { "data": "address.street" }, { "data": "address.city" }, { "data": "phone" }],
        'order': [[1, 'asc']],
        'responsive': {
            details: false
        },
    ...
    var table_edit = $(jsSelectorDatatable_Example_edit).DataTable({
        ...
        rowId: "id",
        columns: [{ "data": "name" }, { "data": "address.street" }, { "data": "address.city" }, { "data": "company.name" }, {
            "targets": -1,
    ...
    var table_praktikplads = $(jsSelectorDatatable_Example_praktikplads).DataTable({
        ...
        rowId: "id",
        columns: [{ "data": "student", "width": "20%" }, { "data": "birthday" }, { "data": "education" }, { "data": "education2" }, { "data": "education3" }, { "data": "education4" }],
        order: [[1, 'asc']],
        paging: false,
        searching: false,
        info: false,
...
},{"datatables.net":3,"datatables.net-responsive":1,"datatables.net-select":2,"jquery":4}]},{},[5]);
